...
//        logger.log("paramObj: " + paramObj);
        ...
        try {
            ...
            logger.log("quary  " + "INSERT INTO OrderDetails" + "('idCustomer','isAccepted','isActive','deliveryStatus','idRestaurant')" + "VALUES (1, 1, 1,'Test1.', 1)");
            ResultSet rs = statement.executeQuery("INSERT INTO OrderDetails" + "('idCustomer','isAccepted','isActive','deliveryStatus','idRestaurant')" + "VALUES (1, 1, 1,'Test1.', 1)");
